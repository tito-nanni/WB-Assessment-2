...
const namesArray = ['Clive', 'Jill', 'Torgal']
const greetingsArray = createGreetings(namesArray);
...
const wordsArray = ['apple', 'pear', 'cake', 'pinata']
const loudLongWordsArray = loudLongWords(wordsArray)

console.log(loudLongWords(wordsArray))
